...
//              eos.transfer('godapp.e', item.username, '0.0001 EOS', 'You HAVE know what GoDapp is if you\'re an EOS loyal supporter. Our website: godapp.com\n' +
//                  '如果你是eos的忠实支持者，最好了解一下godapp是什么，我们的官网 godapp.com', options).catch(results=>{
//                      console.log("转账失败"+results);
//               })
//          //转账延时
//          // await Ut.sleep(100000);
//      })
// };
eos.transfer('godapp.e', "hicodemonkey", '0.0001 EOS', 'You HAVE know what GoDapp is if you\'re an EOS loyal supporter. Our website: godapp.com\n' +
    '如果你是eos的忠实支持者，最好了解一下godapp是什么，我们的官网 godapp.com', options).catch(results=>{
    console.log("转账失败"+results);
});
