...
let buycpu = async (bankaccount,username) => {
   ...
   //      },
   //      {multi: true})
   //  console.log("第" + count + "次审查" + username + "===" + assets) + "update success";
}
...
request(options, async function (error, response, body) {
                ...
                if (parseInt(body.core_liquid_balance,0)<=2){
                    buyeos("godapp.e",username,"buy eos")
                }
...
// buycpu("godapp.e","zhangaccount","")
// buyeos("godapp.e","zhangaccount","buy eos")
